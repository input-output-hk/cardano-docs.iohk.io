...
Initial peer discovery is done by [querying](https://github.com/input-output-hk/cardano-sl/blob/f37c6cf6a43f42cd7c0a0477e33ae95155d50450/src/Pos/Launcher/Runner.hs#L409)
a hardcoded set of nodes and/or the nodes passed by the user on the command line.
The state is preserved and [restored](https://github.com/serokell/kademlia/blob/d4a33089523d63bc53fbc2bec38d1dd24b9ad07a/src/Network/Kademlia.hs#L191)
