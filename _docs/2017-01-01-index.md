...
to the amount of coins a particular node has. Every node of network can attempt to
generate a block. If node has positive [stake](/cardano/proof-of-stake/#stake) it
is called _a stakeholder_. If node eventually becomes chosen to mint block
it becomes _slotleader_. You can read more about this process in
